...
var BundleManager_1 = require("./Operations/BundleManager");
var artifacts_enum_1 = require("./utils/artifacts_enum");
var OperationsManager_1 = require("./Operations/OperationsManager");
function main() {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 9:
                    _b.sent();
                    return [3 /*break*/, 11];
                case 10: throw new Error("Operation not supported : ".concat(operation));
